...
const ManageAdd = props => {
    ...
    axios
      ...
      .then(res => {
        ...
        if (res.data.success === 'true') {
          console.log('advertisement_list_vender', res);
  ...
  return (
    <View style={{ backgroundColor: Colors.white, flex: 1 }}>
      <Header name="Manage Advertisement" searchBtn={true} imgBack={true} />
      {/* Buttons */}
      <View style={s.btn_1}>
        <TouchableOpacity
          style={[s.btn1]}
          onPress={() => props.navigation.navigate('AddAd')}
          activeOpacity={0.8}>
          <Text style={[s.btn1Text]}>Add Advertisement</Text>
        </TouchableOpacity>
      </View>
      {/* View */}
      <View style={s.SEC2}>
                      ...
                      <Card
                        ...
                        <ImageBackground
                          ...
                          <View
                            ...
                            <Text style={s.place}>KWD {item.rental_price}</Text>
                          </View>
                        </ImageBackground>
                        {/*  */}
                        <View style={s.SEC3}>
      ...
      <Overlay
        ...
        <View style={{ padding: 10, width: Sizes.width * 0.8 }}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate('viewAdd', { item: Data })}>
            <Text
              style={{
                fontFamily: FontFamily.semi_bold,
                fontSize: 16,
